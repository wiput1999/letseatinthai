...
@section('content')
  <div class="container-fluid no-footer" style="padding-top: 10px;">
    <div class="col-lg-12 ble ">
        <nav class="bll">
          <div class="blf">
            <button class="bkb bkd blg collapsed" type="button" data-toggle="collapse" data-target="#nav-toggleable-md" aria-expanded="false">
...
<div class="col-sm-12 main">
  ...
  <div class="row grid">
    ...
    <!-- start 1 menu -->
    <div class="col-sm-3 grid-item  thumbnail_hover thumbnail_hover">
      <div class="thumbnail">
        <img class="img-responsive" src="https://thecozycook.com/wp-content/uploads/2015/02/Bobby-Flay-Meatball-Recipe.jpg" alt="Waffle">
        <div class="caption">
...
<!-- end this menu -->
    ...
    <div class="col-sm-3 grid-item  thumbnail_hover">
      <div class="thumbnail">
        <img class="img-responsive" src="https://atmedia.imgix.net/08bd6ad4d2ff82b8fb15cfa5c41bef05bf565752?auto=format&q=45&w=600.0&h=800.0&fit=max&cs=strip" alt="Waffle">
        <div class="caption">
          <h4 class="card-title">Waffle</h4>
          <p class="card-text">A waffle is a dish made from leavened batter or dough that is cooked between two plates</p>
          <div class="btn-group">
            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Edit <span class="caret"></span>
            </button>
    ...
    <div class="col-sm-3 grid-item  thumbnail_hover">
      <div class="thumbnail">
        <img class="img-responsive" src="https://www.theramenrater.com/wp-content/uploads/2015/03/2015_3_9_1615_001.jpg" alt="Waffle">
        <div class="caption">
    ...
    <div class="col-sm-3 grid-item  thumbnail_hover">
      <div class="thumbnail">
        <img class="img-responsive" src="http://www.pbplc.co.th/fh/en/images/uploads/Snack%20Bread/13-16-04-449389750.jpg" alt="Waffle">
        <div class="caption">
